...
local silver_sand = minetest.get_content_id("mcl_core:stone")
local dirt = minetest.get_content_id("mcl_core:dirt")
local stone = minetest.get_content_id("mcl_core:stone")
local silver_sandstone_block = minetest.get_content_id("mcl_core:stone")
local stone_block = minetest.get_content_id("mcl_core:stone")
local stone_brick = minetest.get_content_id("mcl_core:stonebrick")
local obsidian = minetest.get_content_id("mcl_core:obsidian")
local cobblestone = minetest.get_content_id("mcl_core:cobble")
local bush_leaves = minetest.get_content_id("mcl_trees:leaves_oak")
local gravel = minetest.get_content_id("mcl_core:gravel")
local dirt_with_grass = minetest.get_content_id("mcl_core:dirt_with_grass")
local sand = minetest.get_content_id("mcl_core:sand")
local desert_sand = minetest.get_content_id("mcl_core:redsand")
local water = minetest.get_content_id("mcl_core:water_source")
local dirt_with_dry_grass = minetest.get_content_id("mcl_lush_caves:rooted_dirt")
local gold_block = minetest.get_content_id("mcl_core:goldblock")
local copper_block = minetest.get_content_id("mcl_copper:block")
local steel_block = minetest.get_content_id("mcl_core:ironblock")
local diamond_block = minetest.get_content_id("mcl_core:diamondblock")
local stair = minetest.get_content_id("mcl_stairs:stair_oak")
local fence = minetest.get_content_id("mcl_fences:oak_fence")
local cobblestone_wall = minetest.get_content_id("mcl_walls:cobble")
local desert_cobble_wall = minetest.get_content_id("mcl_walls:sandstone")
local gate = minetest.get_content_id("mcl_fences:oak_fence_gate")
local grass = minetest.get_content_id("mcl_flowers:tallgrass")
local brick = minetest.get_content_id("mcl_core:brick_block")
local wood = minetest.get_content_id("mcl_trees:tree_oak")
